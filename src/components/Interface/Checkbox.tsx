...
const Checkbox: React.FC<CheckboxProps> = ({label, questionMessage}) => {
    const id = v4();
        ...
        <div className="checkbox-wrapper">
            ...
            {questionMessage ? (
                <div className="checkbox-message">
                    <div
                        className="checkbox-message-icon-wrapper"
                        onClick={openCheckboxMessage}
                    >
                        <div className="checkbox-message-icon">
                            <svg
                                width="23"
                                height="23"
                                viewBox="0 0 23 23"
                        ...
                        <div
                            className={`checkbox-message-icon-active ${
