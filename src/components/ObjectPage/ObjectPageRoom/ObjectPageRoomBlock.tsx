...
const ObjectPageRoomBlock: React.FC<any> = ({
    ...
    return (
        <div className="object-page-section-room-block-wrapper">
            <div className="object-page-section-room-block">
                <div className="object-page-section-room-block-subblock-info">
                    <div
                ...
                <div className="object-page-section-room-block-subblock-price">
                    <div className="object-page-section-room-block-subblock-price-block">
                        <h3 className="object-page-section-room-block-subblock-price-block__title">
                            <NumberFormat
                                value={price}
                                displayType={"text"}
                                thousandSeparator={" "}
                    ...
                    <div className="object-page-section-room-block-subblock-price-block">
                        <Link
                            to={
                                isLogin
                                    ? `/payment/${hotel_id}/${id}?${date_query}`
                                    : `${window.location.search}&is_redirect=false#login`
                            }
            ...
            {/* <div className="object-page-section-room-block-add-btn">
                <button
                    ...
                    onClick={() => setIsVisibleAddBlock(!isVisibleAddBlock)}
                >
                    {isVisibleAddBlock
                        ? "Скрыть предложения этого номера"
                        : "Другие предложения этого номера"}
                    <svg
                        viewBox="0 0 16 9"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
            ...
            <div className="object-page-section-room-block-add-block-wrapper">
                <AnimateHeight
                    duration={300}
                    height={isVisibleAddBlock ? "auto" : 0}
                >
...
export default ObjectPageRoomBlock;
