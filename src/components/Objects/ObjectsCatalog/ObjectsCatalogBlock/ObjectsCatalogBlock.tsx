                ...
                <div className="objects-catalog-block-text-block left">
                    ...
                    <div className="objects-catalog-block-text-block-subblock">
                        <div className="objects-catalog-block-text-block-subblock-filters">
                            <div className="objects-catalog-block-text-block-subblock-filters-item active">
                                <svg
                                    viewBox="0 0 15 15"
                                    fill="none"
                                    xmlns="http://www.w3.org/2000/svg"
                                ...
                                <p className="objects-catalog-block-text-block-subblock-filters-item__title">
                                    Бесплатная отмена
                                </p>
                            </div>

                            <div className="objects-catalog-block-text-block-subblock-filters-item disabled">
                                <svg
                                    viewBox="0 0 13 15"
                                    fill="none"
                                    xmlns="http://www.w3.org/2000/svg"
