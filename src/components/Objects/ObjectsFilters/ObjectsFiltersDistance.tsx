...
import {ObjectsFiltersBlockWrapper, TitleIcon, InputRange} from "../../";

const ObjectsFiltersDistance: React.FC = () => {
    return (
        <ObjectsFiltersBlockWrapper>
            <div className="objects-filters-block-title">
                <TitleIcon title="Удаленность от центра" marginBottom>
                    <svg
                        width="16"
                        height="18"
                        viewBox="0 0 16 18"
            ...
            <div className="objects-filters-block-input-range">
                <InputRange />
            </div>
        </ObjectsFiltersBlockWrapper>
    );
...
export default ObjectsFiltersDistance;
