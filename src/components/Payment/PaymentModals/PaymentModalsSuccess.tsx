...
const PaymentModalsSuccess: React.FC = () => {
    return (
        <div className="reglog-content-padding">
            <div className="reglog-success">
                ...
                <div className="reglog-success-text">
                    <h2 className="reglog-success-text__title">
                        Бронирование завершено!
                    </h2>
                    <p className="reglog-success-text__description">
                        Мы выслали всю информацию по заказу на указанную Вами
                        почту
                    </p>
                    <p className="reglog-success-text__description">
                        Вы также можете отслеживать бронирование в личном
                        кабинете. Для этого можете{" "}
                        <Link to="/cabinet/history">
                            Перейти к бронированиям
                        </Link>
                    </p>
                    <Link to="/" className="btn reglog-success-text__btn">
                        На главную
                    </Link>
                </div>
            </div>
...
export default PaymentModalsSuccess;
