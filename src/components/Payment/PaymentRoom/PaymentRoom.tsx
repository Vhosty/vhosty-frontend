...
import {ServiceIcon, ImageBox} from "../../../components/";

const PaymentRoom: React.FC<any> = ({
    images,
    room_category_name,
    bed_type_text,
    food_is_included,
    ...
    return (
        <>
            ...
            <div
                className={`payment-info-room-and-contact-room-block ${
                    media ? "media" : ""
                }`}
            >
                <div
                ...
                >
                    <p
                        className="payment-info-room-and-contact-room-block-cover__count"
                        onClick={() => setIsOpenImageBox(true)}
                    >
                        {images.length} фото
                    </p>
                </div>
                <div className="payment-info-room-and-contact-room-block-text">
                    ...
                    <div className="payment-info-room-and-contact-room-block-text-block">
                        ...
                        {food_is_included ? (
                            <ServiceIcon marginBottom green>
                                <svg
                                    viewBox="0 0 13 15"
                                    fill="none"
                                    xmlns="http://www.w3.org/2000/svg"
